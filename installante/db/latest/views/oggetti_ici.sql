...
--changeset abrandolini:20250326_152401_oggetti_ici stripComments:false runOnChange:true 
 
create or replace force view oggetti_ici as
...
and PRATICHE_TRIBUTO.TIPO_TRIBUTO = 'ICI';
comment on table OGGETTI_ICI is 'OGIC - Oggetti contribuente ICI';
