...
--changeset abrandolini:20250326_152401_forniture_ae_g1 stripComments:false runOnChange:true 
 
create or replace force view forniture_ae_g1 as
select documento_id
 ,progressivo
 ,tipo_record
 ...
 ,importo_ifel
   ,importo_lordo
   from forniture_ae
  where tipo_record = 'G1';
comment on table FORNITURE_AE_G1 is 'FAG1 - Forniture AE G1';
