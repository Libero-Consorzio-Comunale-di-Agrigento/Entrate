...
--changeset abrandolini:20250326_152401_periodi_ogco_tarsu stripComments:false runOnChange:true 
 
create or replace force view periodi_ogco_tarsu as
select ogco.cod_fiscale
 ...
 and prtr.tipo_tributo in ('TARSU')
...
comment on table PERIODI_OGCO_TARSU is 'Periodi OGCO TARSU';
