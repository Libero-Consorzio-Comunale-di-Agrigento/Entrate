...
--changeset abrandolini:20250326_152401_sto_web_oggetti_pratica stripComments:false runOnChange:true 
 
CREATE OR REPLACE FORCE VIEW STO_WEB_OGGETTI_PRATICA AS
SELECT  ogpr.oggetto_pratica as oggetto_pratica_rendita,
          ...
          DECODE (
             ...
             ID_TARIFFA
     FROM sto_oggetti_pratica ogpr;
comment on table STO_WEB_OGGETTI_PRATICA is 'STO_WEB_OGGETTI_PRATICA';
