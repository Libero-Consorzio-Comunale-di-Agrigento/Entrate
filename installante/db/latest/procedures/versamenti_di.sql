...
--changeset abrandolini:20250326_152423_versamenti_di stripComments:false runOnChange:true 
 
CREATE OR REPLACE PROCEDURE VERSAMENTI_DI
...
BEGIN
  ...
  ELSIF (a_rata not between 0 and 72) and a_pratica is not null THEN
     RAISE_APPLICATION_ERROR
       (-20999,'Rata indicata non corretta (Valori validi: Tra 0 e 72)');
  END IF;
END;
/* End Procedure: VERSAMENTI_DI */
/
