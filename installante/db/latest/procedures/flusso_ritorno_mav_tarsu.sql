...
--changeset abrandolini:20250326_152423_flusso_ritorno_mav_tarsu stripComments:false runOnChange:true 
 
create or replace procedure FLUSSO_RITORNO_MAV_TARSU
   (
...
BEGIN
   ...
   FOR i IN 0 .. w_numero_righe - 1 LOOP
      ...
      -- Reset delle variabili quando finisce un blocco
      if substr(w_riga, 2,2) = 'EF' then
         w_progressivo14  := 0;
         w_causale        := '';
         w_progressivo51  := 0;
      end if;
...
END;
/* End Procedure: FLUSSO_RITORNO_MAV_TARSU */
/
