...
--changeset abrandolini:20250326_152423_inserimento_sanzione_ici_gg stripComments:false runOnChange:true 
 
create or replace procedure INSERIMENTO_SANZIONE_ICI_GG
/*************************************************************************
 ...
 3         20/07/2016        VD        Aggiunto dimezzamento sanzione per
                                       codice sanzione 504 (mini IMU)
 2         12/07/2016        AB        Controllo della data pratica
                                       (relativi a pratiche dal 2016) per il
                                       dimezzamento della sanzione 206 e 208
...
BEGIN -- f_importo_sanzione_ici
    ...
    BEGIN
      select sanz.sanzione_minima
           , sanz.sanzione
           , case
               when w_data_pratica >= to_date('01/01/2016','dd/mm/yyyy') and p_cod_sanzione in (206,208,504) then
                 (sanz.percentuale/2) * p_gg_diff
             else
               sanz.percentuale * p_gg_diff
             end
           , sanz.riduzione
           , sanz.riduzione_2
...
--------------------------------------------------------
BEGIN
  w_impo_sanz := f_round(f_importo_sanzione_ici(a_pratica,a_cod_sanzione,a_tipo_tributo,a_impo_base,a_gg_diff,a_data_inizio,
...
END;
/* End Procedure: INSERIMENTO_SANZIONE_ICI_GG */
/
