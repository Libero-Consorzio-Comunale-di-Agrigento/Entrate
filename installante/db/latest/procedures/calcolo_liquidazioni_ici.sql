...
--changeset abrandolini:20250326_152423_calcolo_liquidazioni_ici stripComments:false runOnChange:true 
 
create or replace procedure CALCOLO_LIQUIDAZIONI_ICI
/*************************************************************************
 Rev.  Data          Autore    Descrizione
 8     20/09/2022    VM        #66699 - sostituito filtro ricerca sogg.cognome_nome 
                               con sogg.cognome_nome_ric
 7     25/08/2022    VD        Redmine 48451: aggiunta eliminazione
                               sanzioni per contribuenti deceduti
 6     20/01/2020    VD        Aggiunto controllo per non ricalcolare
                               le pratiche inserite dai verificatori:
                               se la funzione F_CHECK_DELETE_PRATICA
                               restituisce 1, la pratica non è da
                               ricalcolare
 5     19/11/2019    VD        Modificato controllo liquidabilita del
 ...
 4     22/10/2019    VD        Aggiunto motivo di non liquidabilita del
        ...
        ELSE
           ...
           --
             ...
             EXCEPTION
                ...
                w_chkLiquida := 0;
                WHEN OTHERS THEN
                w_errore := 'Errore in ricerca Denunce in ritardo ('||SQLERRM||')';
                RAISE errore;
             END;*/
             --
...
END;
/* End Procedure: CALCOLO_LIQUIDAZIONI_ICI */
/
