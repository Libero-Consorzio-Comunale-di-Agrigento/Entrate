...
--changeset abrandolini:20250326_152438_f_detrazione_raop_tasi stripComments:false runOnChange:true 
 
create or replace function F_DETRAZIONE_RAOP_TASI
...
EXCEPTION
   WHEN OTHERS THEN
        RETURN null;
END;
/* End Function: F_DETRAZIONE_RAOP_TASI */
/
