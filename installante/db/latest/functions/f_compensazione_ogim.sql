...
--changeset abrandolini:20250326_152438_f_compensazione_ogim stripComments:false runOnChange:true 
 
create or replace function F_COMPENSAZIONE_OGIM
...
BEGIN
   ...
   END IF;
END;
/* End Function: F_COMPENSAZIONE_OGIM */
/
