...
--changeset abrandolini:20250326_152438_f_calcolo_interessi_gg_titr stripComments:false runOnChange:true 
 
create or replace function F_CALCOLO_INTERESSI_GG_TITR
(a_importo          in     number
,a_dal              in     date
,a_al               in     date
,a_gg_anno          in     number
...
--' Giorni = '||to_char(rec_periodo.al + 1 - rec_periodo.dal));
   END LOOP;
   Return w_interessi;
END;
/* End Function: F_CALCOLO_INTERESSI_GG_TITR */
/
