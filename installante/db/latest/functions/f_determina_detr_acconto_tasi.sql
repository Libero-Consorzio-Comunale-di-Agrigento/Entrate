...
--changeset abrandolini:20250326_152438_f_determina_detr_acconto_tasi stripComments:false runOnChange:true 
 
create or replace function F_DETERMINA_DETR_ACCONTO_TASI
(a_anno            IN NUMBER
...
BEGIN
   ...
   Return nDetrazione;
END;
/* End Function: F_DETERMINA_DETR_ACCONTO_TASI */
/
