...
--changeset abrandolini:20250326_152438_f_determina_aliquote_tasi stripComments:false runOnChange:true 
 
create or replace function F_DETERMINA_ALIQUOTE_TASI
...
--      END;
--   else
      w_tipo_al_terreni_prec := w_tipo_al_terreni;
      w_al_terreni_prec := w_al_terreni;
--   end if;
...
--            RAISE errore;
--      END;
      w_tipo_al_terreni_rid_prec := w_tipo_al_terreni_rid;
      w_al_terreni_rid_prec := w_al_terreni_rid;
--   end if;
...
EXCEPTION
   ...
   WHEN OTHERS THEN
      Return -2;
END;
/* End Function: F_DETERMINA_ALIQUOTE_TASI */
/
