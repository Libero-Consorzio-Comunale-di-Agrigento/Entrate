...
--changeset abrandolini:20250326_152438_f_altri_importo_acconto stripComments:false runOnChange:true 
 
create or replace function F_ALTRI_IMPORTO_ACCONTO
(  a_pratica           NUMBER,
...
BEGIN
                          ...
                          DECODE (NVL (ogpr.tipo_oggetto, ogge.tipo_oggetto),
                                  ...
                                  decode (nvl(aliq.flag_fabbricati_merce,'N'),
                                         ...
                                         DECODE (ogim.aliquota_erariale,
                                                 NULL, 0,
                                                   NVL (DECODE (a_tipo,
                                                                'RENDITA', ogim.imposta_acconto,
                                                                ogim.imposta_dovuta_acconto
                                                               ),
                                                        0
                                                       )
                                                 - NVL (DECODE (a_tipo,
                                                                'RENDITA', ogim.imposta_erariale_acconto,
   ...
   RETURN dep_ret;
END;
/* End Function: F_ALTRI_IMPORTO_ACCONTO */
/
