...
--changeset abrandolini:20250326_152438_f_calcolo_rata_tarsu stripComments:false runOnChange:true 
 
create or replace function F_CALCOLO_RATA_TARSU
/******************************************************************************
 NOME:        F_CALCOLO_RATA_TARSU
 Rev.  Data        Autore  Descrizione
 ----  ----------  ------  ----------------------------------------------------
   000   xx/xx/xxxx  XX      Versione iniziale
   001   04/06/2024  RV      #72976
                             Aggiunto gestione Componenti Perequative, gestite
                             come la vecchia Maggiorazione Tares
   002   04/10/2024  RV      #73212
                             Aggiunto tipo 'Y', come 'X' ma ignora qualsiasi versato
   003   14/01/2025  RV      #71531
                             Lo sgravio maggiorazione_tares veniva erroneamente applicato
                             anche sull'imposta netta
   004   13/02/2025  RV      #77805
                             Rivisto per componenti perequative spalmate
   005   10/03/2025  RV      #78970
                             Rivisto per importi eccedenze
                             Uniformato con F_CALCOLO_RATA_RC_TARSU
******************************************************************************
-- p_tipo_rata :
--    I - Imposta - Versato_Imposta
--    Q - (Imposta + Perequative) - Versato_Imposta    (#72976 +)
--    P - Addizionali - Versato_Addizionali
--    R - Solo Perequative
--    T - Imposta + Addizionali - Versato_Imposta - Versato_Addizionali
--    X - (Imposta + Perequative) + Addizionali - Versato_Imposta - Versato_Addizionali    (#72976 +)
--    Y - (Imposta + Perequative) + Addizionali                                            (#73212 +)
*****************************************************************************/
...
--dbms_output.put_line('Sbilancio: '||w_sbil_tares_ruolo||', rata: '||w_sbil_tares_rata);
  ...
  if w_tipo_rata in ('Y') then
    -- Versato gi� ignorato, procede come fosse 'X'
    w_tipo_rata := 'X';
  end if;
  --
     if p_rata = 0 then
...
/* End Function: F_CALCOLO_RATA_TARSU */
/
