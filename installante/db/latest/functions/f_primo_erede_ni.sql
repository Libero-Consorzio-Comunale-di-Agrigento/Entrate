...
--changeset abrandolini:20250326_152438_f_primo_erede_ni stripComments:false runOnChange:true 
 
create or replace function F_PRIMO_EREDE_NI
( A_NI        IN number
)
RETURN varchar2
is
