...
--changeset abrandolini:20250326_152438_f_importo_pert_ruolo stripComments:false runOnChange:true 
 
create or replace function F_IMPORTO_PERT_RUOLO
(a_ogpr    number
,a_ruolo   number
,a_tributo number)
RETURN number
...
BEGIN
   BEGIN
   select nvl(sum(nvl(ruco.importo ,0)),0)
     into w_return
  ...
  RETURN w_return;
END;
/* End Function: F_IMPORTO_PERT_RUOLO */
/
