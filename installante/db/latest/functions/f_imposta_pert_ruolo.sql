...
--changeset abrandolini:20250326_152438_f_imposta_pert_ruolo stripComments:false runOnChange:true 
 
create or replace function F_IMPOSTA_PERT_RUOLO
(a_ogpr    number
,a_ruolo   number
,a_tributo number)
RETURN number
...
BEGIN
   BEGIN
   select nvl(sum(nvl(ogim.imposta ,0)),0)
     into w_return
  ...
  RETURN w_return;
END;
/* End Function: F_IMPOSTA_PERT_RUOLO */
/
