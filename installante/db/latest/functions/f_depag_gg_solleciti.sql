...
--changeset abrandolini:20250326_152438_f_depag_gg_solleciti stripComments:false runOnChange:true 
 
create or replace function F_DEPAG_GG_SOLLECITI
/*************************************************************************
 NOME:        F_DEPAG_GG_SOLLECITI
 ...
 RITORNA:     number              giorni da sommare alla data scadenza
 NOTE:
 Rev.    Date         Author      Note
 000     22/02/2023   AB         Prima emissione.
*************************************************************************/
...
BEGIN
  begin
     select inpa.valore
      ...
      where inpa.parametro = 'DEPA_GG_S'
         ;
  exception
     when others then
       w_valore_inpa := '';
...
/* End Function: F_DEPAG_GG_SOLLECITI */
/
