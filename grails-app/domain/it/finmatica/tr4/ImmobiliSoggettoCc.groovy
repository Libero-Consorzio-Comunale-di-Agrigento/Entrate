...
class ImmobiliSoggettoCc implements Serializable {
	...
	static mapping = {
		id composite: ["contatore", "proprietario", "codFiscaleRic", "indirizzo", "numCiv", "lotto", "edificio", "scala", "interno", "piano", "numeratore", "denominatore", "codTitolo", "desTitolo", "tipoImmobile", "partitaTitolarita", "partita", "sezione", "foglio", "numero", "subalterno", "zona", "categoria", "classe", "consistenza", "rendita", "renditaEuro", "descrizione", "dataEfficacia", "dataIscrizione", "estremiCatasto", "sezioneRic", "foglioRic", "numeroRic", "subalternoRic", "indirizzoRic", "zonaRic", "categoriaRic", "partitaRic"]
