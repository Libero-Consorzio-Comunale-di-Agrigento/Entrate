...
class AnagrafeTributariaControlloJob {

	private static Log log = LogFactory.getLog(AnagrafeTributariaControlloJob)
	...
	def description = "Controllo anagrafe tributaria"
	...
	def execute(context) {
		...
		try {
			...
			allineamentoAnagrafeTributariaService.controlloAT(null, attivita)
