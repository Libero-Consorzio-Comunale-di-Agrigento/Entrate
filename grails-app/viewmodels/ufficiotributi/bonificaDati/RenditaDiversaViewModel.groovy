...
class RenditaDiversaViewModel extends HelpAnomaliePraticheViewModel {
    ...
    init(@ContextParam(ContextType.COMPONENT) Window w
        ...
        praticaSelezionata.anomalia.anomaliaParametro.anno = anomaliaSelezionata.anno
        praticaSelezionata.anomalia.anomaliaParametro.flagImposta = anomaliaSelezionata.flagImposta

        ogcoHelp = gestioneAnomalieService.getOgcoAnomali(praticaSelezionata,
                oggettoContribuente.oggettoPratica.pratica.tipoTributo.tipoTributo,
                praticaSelezionata.anomalia.anomaliaParametro.flagImposta)
