...
class F24ViolazioniTARSUQuery {

    static def query() {
        return  """
select 'TARSU' as tributo,
       decode('C',
       ...
       '' rateazione,
       to_number(null) rate,
       'ACC' || nvl(prat.tipo_evento, 'U') || to_char(prat.anno) ||
       lpad(to_char(prat.pratica), 10, '0') identificativo_operazione
  from ad4_comuni ad4_comuni_a,
       ...
       (select to_number(null) num_fab_prat,
         ...
         where prtr.tipo_pratica in ('A', 'S')
 ...
 where ad4_comuni_a.provincia_stato = ad4_provincie_a.provincia(+)
   ...
   and contribuenti.cod_fiscale = :pCodFiscale
