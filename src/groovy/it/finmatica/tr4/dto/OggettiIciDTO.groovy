...
import it.finmatica.tr4.OggettiIci;

import java.util.Date;
import java.util.Map;

public class OggettiIciDTO implements it.finmatica.dto.DTO<OggettiIci> {
    ...
    public OggettiIci getDomainObject () {
        return OggettiIci.createCriteria().get {
    ...
    public OggettiIci toDomain(Map overrides = [:]) {
