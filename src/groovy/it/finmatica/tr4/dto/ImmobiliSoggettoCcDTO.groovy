...
import it.finmatica.tr4.ImmobiliSoggettoCc

public class ImmobiliSoggettoCcDTO implements it.finmatica.dto.DTO<ImmobiliSoggettoCc> {
    ...
    public ImmobiliSoggettoCc getDomainObject () {
        return ImmobiliSoggettoCc.createCriteria().get {
    ...
    public ImmobiliSoggettoCc toDomain(Map overrides = [:]) {
