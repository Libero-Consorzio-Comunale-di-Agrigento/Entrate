...
import it.finmatica.tr4.datiesterni.FornituraAEG1;
import it.finmatica.tr4.dto.datiesterni.DocumentoCaricatoDTO;

public class FornituraAEG1DTO implements it.finmatica.dto.DTO<FornituraAEG1> {
	...
	public FornituraAEG1 getDomainObject () {
		return FornituraAEG1.createCriteria().get {
			eq('documentoCaricato', this.documentoCaricato.getDomainObject())
			eq('progressivo', this.progressivo)
		}
	}
	
	public FornituraAEG1 toDomain(Map overrides = [:]) {
